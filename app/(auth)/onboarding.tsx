...
export default function OnboardingScreen() {
  const { completeOnboarding, skipOnboarding, logout, isLoading, error, clearError } =
    useAuthStore();
  ...
  const handleCancel = () => {
    Alert.alert("Go back to login?", "Your account will not be saved.", [
      { text: "Stay", style: "cancel" },
      { text: "Go back", style: "destructive", onPress: () => void logout() },
    ]);
  };
      ...
      >
        ...
        >
          ...
          <View className="gap-3 mt-8">
            ...
            >
              <Text className="text-error text-sm">Cancel</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
